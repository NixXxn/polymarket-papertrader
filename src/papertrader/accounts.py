...
STRATEGY_NAMES = ("safe", "asymmetric", "contrarian", "conviction", "obieweather", "copy", "esports", "fadefinder", "momentum", "meanrev", "volspike", "closingsoon", "btc5m", "arbitrage", "penny", "endgame")
