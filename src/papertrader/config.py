...
def load_settings(
    ...
    return Settings(
        ...
        arbitrage=ArbitrageSettings(
            max_pair_cost=float(arbitrage_raw.get("max_pair_cost", 0.96)),
            max_maker_ask_sum=float(arbitrage_raw.get("max_maker_ask_sum", 1.04)),
            min_edge=float(arbitrage_raw.get("min_edge", 0.02)),
            fee_buffer=float(arbitrage_raw.get("fee_buffer", 0.01)),
            min_liquidity=float(arbitrage_raw.get("min_liquidity", 300.0)),
            min_volume_24h=float(arbitrage_raw.get("min_volume_24h", 100.0)),
            min_ask=float(arbitrage_raw.get("min_ask", 0.02)),
            max_ask=float(arbitrage_raw.get("max_ask", 0.95)),
            min_ask_size=float(arbitrage_raw.get("min_ask_size", 5.0)),
            book_fill_fraction=float(arbitrage_raw.get("book_fill_fraction", 0.75)),
            position_usd=float(arbitrage_raw.get("position_usd", 40.0)),
            max_position_usd=float(arbitrage_raw.get("max_position_usd", 80.0)),
            max_open_pairs=int(arbitrage_raw.get("max_open_pairs", 6)),
        ...
        endgame=EndgameSettings(
            ...
            price_min=float(endgame_raw.get("price_min", 0.88)),
            price_max=float(endgame_raw.get("price_max", 0.96)),
            min_liquidity=float(endgame_raw.get("min_liquidity", 150.0)),
            min_ask_size=float(endgame_raw.get("min_ask_size", 8.0)),
            book_fill_fraction=float(endgame_raw.get("book_fill_fraction", 0.8)),
            use_full_capital=bool(endgame_raw.get("use_full_capital", False)),
            position_usd=float(endgame_raw.get("position_usd", 60.0)),
            max_position_usd=float(endgame_raw.get("max_position_usd", 100.0)),
            max_open_positions=int(endgame_raw.get("max_open_positions", 3)),
            ...
            poll_interval_seconds=int(endgame_raw.get("poll_interval_seconds", 15)),
            starting_balance=(
