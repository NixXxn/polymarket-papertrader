...
def load_settings(
    ...
    return Settings(
        ...
        arbitrage=ArbitrageSettings(
            max_pair_cost=float(arbitrage_raw.get("max_pair_cost", 0.93)),
            max_maker_ask_sum=float(arbitrage_raw.get("max_maker_ask_sum", 1.03)),
            min_edge=float(arbitrage_raw.get("min_edge", 0.03)),
            fee_buffer=float(arbitrage_raw.get("fee_buffer", 0.015)),
            min_liquidity=float(arbitrage_raw.get("min_liquidity", 600.0)),
            min_volume_24h=float(arbitrage_raw.get("min_volume_24h", 250.0)),
            min_ask=float(arbitrage_raw.get("min_ask", 0.02)),
            max_ask=float(arbitrage_raw.get("max_ask", 0.95)),
            min_ask_size=float(arbitrage_raw.get("min_ask_size", 20.0)),
            book_fill_fraction=float(arbitrage_raw.get("book_fill_fraction", 0.5)),
            position_usd=float(arbitrage_raw.get("position_usd", 30.0)),
            max_position_usd=float(arbitrage_raw.get("max_position_usd", 60.0)),
            max_open_pairs=int(arbitrage_raw.get("max_open_pairs", 5)),
            maker_tick=float(arbitrage_raw.get("maker_tick", 0.01)),
            paper_fak=bool(arbitrage_raw.get("paper_fak", False)),
            ...
            min_pair_profit_pct=float(arbitrage_raw.get("min_pair_profit_pct", 0.02)),
            pair_bid_sum_exit=float(arbitrage_raw.get("pair_bid_sum_exit", 0.985)),
        ),
        weatherlock=WeatherlockSettings(
        ...
        endgame=EndgameSettings(
            ...
            min_liquidity=float(endgame_raw.get("min_liquidity", 400.0)),
            min_ask_size=float(endgame_raw.get("min_ask_size", 25.0)),
            book_fill_fraction=float(endgame_raw.get("book_fill_fraction", 0.6)),
            use_full_capital=bool(endgame_raw.get("use_full_capital", False)),
            position_usd=float(endgame_raw.get("position_usd", 75.0)),
            max_position_usd=float(endgame_raw.get("max_position_usd", 120.0)),
            ...
            stop_bid=float(endgame_raw.get("stop_bid", 0.82)),
            paper_fill_at_limit=bool(endgame_raw.get("paper_fill_at_limit", False)),
